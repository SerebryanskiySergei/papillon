<head>
    ...
    <meta name="description"
          content="ButterFly is a unique design template which is crafted for specially Beauty Salon, Spa Centers, Massage Parlor. Template theme is specially design for ladies/woman stylish/spa/beauty business.">
    <meta property="og:title" content="ButterFly : Spa, Beauty Salon &amp; Massage Template">
    <meta property="og:description"
          content="ButterFly is a unique design template which is crafted for specially Beauty Salon, Spa Centers, Massage Parlor. Template theme is specially design for ladies/woman stylish/spa/beauty business.">
    <meta property="og:image" content="https://butterfly.dexignzone.com/xhtml/social-image.jpg">

    <meta name="format-detection" content="telephone=no">

    <!-- Favicons Icon -->
    <link rel="icon" href="https://butterfly.dexignzone.com/xhtml/images/favicon.ico" type="image/x-icon">
    <link rel="shortcut icon" type="image/x-icon" href="https://butterfly.dexignzone.com/xhtml/images/favicon.png">
    <!-- Page Title Here -->
    ...
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/fontawesome/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/themify/themify-icons.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/flaticon/flaticon.min.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/bootstrap-select/bootstrap-select.min.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/magnific-popup/magnific-popup.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/animate/animate.min.css">
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/scroll/scrollbar.min.css">
    <link rel="stylesheet" type="text/css" href="https://butterfly.dexignzone.com/xhtml/css/style.min.css">
    <link class="skin" rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/css/skin/skin-1.min.css">
    <link rel="stylesheet" type="text/css" href="https://butterfly.dexignzone.com/xhtml/css/templete.css">

    <!-- Revolution Slider Css -->
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/revolution/v5.4.3/css/settings.css">
    <!-- Revolution Navigation Style -->
    <link rel="stylesheet" type="text/css"
          href="https://butterfly.dexignzone.com/xhtml/plugins/revolution/v5.4.3/css/navigation.min.css">
    <!-- Google fonts -->
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="https://butterfly.dexignzone.com/xhtml/css/coming-soon.css">
    ...
    <script type="text/javascript" charset="utf-8" async=""
            src="https://s7.addthis.com/static/layers.ab5cd98fe1b9a38a4a9f.js"></script>
    ...
    <style
        type="text/css">div.at-share-close-control.ats-dark, div.at-share-open-control-left.ats-dark, div.at-share-open-control-right.ats-dark {
            background: #262b30
        }
...
<body id="bg" data-gr-c-s-loaded="true">
<div class="page-wraper">
    <!-- Content -->
    <div class="blog-page-content style-1 sticky-header  ">
        <!-- Side Nav -->
        <div id="mySidenav1" class="sidenav coming-side-bar content cs-sidenav"><a href="javascript:void(0)" class="closebtn bg-primary closebtn">×</a>
            <div class="clearfix"></div>
            <div class="p-a15 p-t15">
                <div class="text-center">
                    <h2 class="m-b10">Страничка находится в разработке</h2>
                    <p class="m-b5">Мы активно работаем над завершением данного раздела сайта, описывающего
                        мужскую депиляцию.</p>
                </div>
                <div class="row m-t50">
                    <div class="col-md-4 col-sm-6 p-a0">
                        <div class="dez-box">
                            <div class="dez-media dez-img-effect off-color ">
                                <img src="https://butterfly.dexignzone.com/xhtml/images/gallery/pic1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 p-a0">
                        <div class="dez-box">
                            <div class="dez-media dez-img-effect off-color ">
                                <img src="https://butterfly.dexignzone.com/xhtml/images/gallery/pic2.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 p-a0">
                        <div class="dez-box">
                            <div class="dez-media dez-img-effect off-color ">
                                <img src="https://butterfly.dexignzone.com/xhtml/images/gallery/pic3.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="">
                    <div class="p-a30 p-t15 text-center">
                        <h2 class="m-b10">Свяжитесь с нами</h2>
                        <p class="max-w500 m-auto m-b0">Несмотря на то, что страничка еще не готова, мы уже предоставляем возможность придти на мужскую депиляцию в наш салон!.
                            Просто позвоните нам, и мы обсудим все вопросы!
                        </p>
                    </div>
                    <div class="p-lr15 clearfix">
                        <div class="col-md-4 col-sm-4 m-b30">
                            <div class="icon-bx-wraper bx-style-1 p-a30 center col">
                                <div class="icon-bx-sm bg-primary m-b20"><a href="#" class="icon-cell"><i
                        ...
                        <div class="col-md-4 col-sm-4  m-b30">
                            <div class="icon-bx-wraper bx-style-1 p-a30 center col">
                                ...
                                <div class="icon-content">
                                    <h5>Адрес</h5>
                                    <p>ул. Свободы, д. 14 (БЦ БИК), оф. 808</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="dez-coming-soon text-black bg-img-fix dez-coming-soon-full overlay-white-light"
            ...
            <div class="container dez-coming-bx ">
                ...
                <div class="text-center m-t50 info-style-1">
                    <a href="#" class="site-button radius-xl m-lr5 openbtn">Узнать больше</a>
                </div>
...
<script type="text/javascript" async=""
        src="https://www.gstatic.com/recaptcha/releases/75nbHAdFrusJCwoMVGTXoHoM/recaptcha__en.js"></script>
<script src="https://butterfly.dexignzone.com/xhtml/js/combine.js"></script>
<script src="https://butterfly.dexignzone.com/xhtml/plugins/countdown/jquery.countdown.js"></script>
<!-- Countdown Js  -->
<script src="https://www.google.com/recaptcha/api.js"></script>
<!-- google api for recaptcha  -->
<script src="https://butterfly.dexignzone.com/xhtml/js/dz.ajax.js"></script>
<!-- dz ajex fuctions  -->
<script src="https://butterfly.dexignzone.com/xhtml/plugins/scroll/scrollbar.min.js"></script>
<!-- Scroll bar -->
</body>
